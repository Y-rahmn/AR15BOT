...
conn.sendMessage(id, '3aalaikumsalam, ada yang bisa saya bantu? kalo bingung ketik !help ya euy...' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, 'Waalaikumsalam, ada yang bisa saya bantu? kalo bingung ketik !help ya euy...' ,MessageType.text);
}
...
conn.sendMessage(id, 'Ya?, ada yang bisa saya bantu? kalo bingung ketik !help ya euy...' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'Ya?, ada yang bisa saya bantu? kalo bingung ketik !help ya euy...' ,MessageType.text);
}
